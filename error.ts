...
/**
 * This class provides a wrapper for network errors when making requests to Hyperplane API Gateway
 */
export class HyperplaneError extends Error {
  /**
   * The response body
   */
